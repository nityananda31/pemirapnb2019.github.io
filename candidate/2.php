    ...
    <div class="container h-100 animatedParent">
      <div class="row h-100 align-items-center justify-content-center text-center">
        <div class="col-lg-6 align-items-center ">
          ...
          <img src="../img/candidate/candidate-2.png" width="500" alt="" srcset="">
        </div>
        <div class="col-lg-6 align-item-center ">
          ...
          <br>
          <br>
          <h1 class="text-uppercase text-dark font-weight-bold animated fadeInRightShort slowest"> Made Wira Cahyanta & Kadek Pande Sanjaya Sugiarta </h1>
          <p class="candidate-quotes mt-5 align-self-end animated fadeInDownShort"> " Aktif, Kreatif, Solidaritas, dan Integritas "</p>
    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-8 about-text text-center">
          ...
          <p class="text-white mb-4 animated fadeIn slowest">Menjadikan Keluarga Besar Mahasiswa sebagai Wadah bagi
              Mahasiswa Politeknik Negeri Bali yang Penuh AKSI
              (Aktif, Kreatif, Solidaritas, dan Integritas)
      ...
      <div class="row">
        <div class="col-lg-3 col-md-6 text-center">
          <div class="mt-5">
            ...
            <h3 class="h4 mb-2"> Responsive & Sinergi </h3>
            <p class="text-muted mb-0">Mewujudkan Keluarga Besar Mahasiswa yang responsif dan
              bersinergi dengan seluruh civitas akademika Politeknik Negeri Bali.
            </p>
          </div>
        </div>
        <div class="col-lg-3 col-md-6 text-center">
          <div class="mt-5">
            <i class="fas fa-4x fa-comments text-dark mb-4"></i>
            <h3 class="h4 mb-2">Fasilitator Dan Mediator </h3>
            <p class="text-muted mb-0">Sebagai fasilitator dan mediator untuk menampung
                aspirasi mahasiswa di bidang akademik maupun
                non akademik
            </p>
          </div>
        </div>
        <div class="col-lg-3 col-md-6 text-center">
          <div class="mt-5">
            <i class="fas fa-4x fa-hands-helping text-dark mb-4"></i>
            <h3 class="h4 mb-2"> Harmonisasi </h3>
            <p class="text-muted mb-0">Membangun harmonisasi antar organisasi mahasiswa
                Politeknik Negeri Bali dengan menerapkan budaya 5S
        ...
        <div class="col-lg-3 col-md-6 text-center">
          <div class="mt-5">
            <i class="fas fa-4x fa-user-graduate text-dark mb-4"></i>
            <h3 class="h4 mb-2"> Profesionalitas dan Moralitas </h3>
            <p class="text-muted mb-0"> Menumbuhkan nilai profesionalitas, moralitas,
                dan integritas untuk Keluarga Besar Mahasiswa yang lebih baik
            </p>
          </div>
        </div>
      </div>
