    ...
    <div class="container h-100 animatedParent">
      <div class="row h-100 align-items-center justify-content-center text-center">
        <div class="col-lg-6 align-items-center ">
          ...
          <img src="/img/icon/main-logo.png" width="500" alt="" srcset="">
        </div>
        <div class="col-lg-6 align-item-center ">
          ...
          <br>
          <br>
          <h1 class="text-uppercase text-dark font-weight-bold animated fadeInRightShort slowest">I Made Bongol & I Ketut Chubby </h1>
          <p class="candidate-quotes mt-5 align-self-end animated fadeInDownShort"> " Berjuang untuk bangsa dan Negara ! "</p>
